...
library CommissionManager {
    ...
    function setCommissionWallet(address commissionWallet, address _newWallet) internal {
        commissionWallet = _newWallet;
        emit CommissionWalletUpdated(_newWallet);
    }

    // Установка нового процента комиссии
    function setCommissionPercentage(uint256 commissionPercentage, uint256 _newPercentage) internal {
