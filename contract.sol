// Интерфейс ERC20 для взаимодействия с токенами
interface IERC20 {
...
contract Payments {
    ...
    function createSubscription(
        ...
        require(
            tokenInterface.allowance(msg.sender, address(this)) >= (_subscriptionCost * 2),
    ...
    function executePayment(address _customer) public virtual {
        ...
        emit SubscriptionPaid(
            ...
            block.timestamp,
            getSubscription(_customer, msg.sender).Allowance,
            block.timestamp + getSubscription(_customer, msg.sender).SubscriptionPeriod
        );
    }
